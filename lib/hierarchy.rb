...
#get the list of parents
	def get_parents
		return self.class.get_parents(id);
	end

#get only the parent ids
	def get_parent_ids
		return self.class.get_parent_ids(id);
	end

#get the full subtree of this child, flattened
	def get_children
		return self.class.get_children(id);
	end

#get the full list of ids that are part of this subtree.
	def get_children_ids
		return self.class.get_children_ids(id);
	end

	def children?
		return self.class.children?(id)
	end
