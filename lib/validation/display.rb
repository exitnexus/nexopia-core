	...
	class Display
		...
		def initialize(field_id, results, show_icon_for_valid=true)
			...
			@icon = "<div id=\"#{@field_id}_error_icon#{@index_text}\" style=\"#{error_style} #{icon_style}\">" +
								"<img class=\"validate_error_image\" src=\"#{$site.static_file_url("core/images/validate_error.gif")}\" />" +
							"</div>" +
							"<div id=\"#{@field_id}_warning_icon#{@index_text}\" style=\"#{warning_style} #{icon_style}\">" +
								"<img class=\"validate_warning_image\" src=\"#{$site.static_file_url("core/images/validate_warning.gif")}\" />" +
							"</div>" + 
							"<div id=\"#{@field_id}_valid_icon#{@index_text}\" style=\"#{valid_style} #{icon_style}\">" +
								"<img class=\"validate_valid_image\" src=\"#{$site.static_file_url("core/images/validate_valid.gif")}\" />" +
							"</div>";
		end
