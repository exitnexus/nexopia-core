...
class Account < Cacheable
	...
	DELETION_REASONS = [
		...
		"I find Nexopia hard to use.",
		"I worry about privacy.",
		"My friends aren't on anymore.",
		"Someone keeps bugging me.",
		"I spend too much time on Nexopia.",
		"Other."
	]
	...
	def log_deletion(reason)
		reason = 0 unless (DELETION_REASONS[reason])
		
		Metrics::MetricData::update_metric(
			Metrics::CategoryUserSignUp::typeid,
			Metrics::CategoryUserSignUp::DELETION_REASON,
			1, reason
		)
	end
