# Warning:  Please don't use this file.  We don't have the dbi gem installed.
require 'dbi'
...
class SqlDBdbi < SqlBase
	...
	def connect()
		...
		begin
			...
			raise ConnectionError.new(e.errstr, e.err)
		end
	...
	def query(query, *params)
		...
		begin
			...
			raise QueryError.new(e.errstr, e.err, prepared)
		end
