...
class ConfigBase
	...
	attr_reader :svn_base_dir, :svn_branch, :site_base_dir, :doc_base_dir, :test_base_dir;
	...
	# Set these if you want all emails or messages to go to a given email address (email) or userid (messages)
	...
	#set to true to always disable timeline_log
	attr_reader :timeline_log_force_disable
	...
	attr_reader :mobile_post_server
	attr_reader :mobile_incoming_ip
	attr_reader :mobile_post_port
	attr_reader :mobile_post_path
	attr_reader :mobile_post_type
	attr_reader :mobile_post_shortcode
	attr_reader :mobile_post_user
	attr_reader :mobile_post_password
	
	attr_reader :cron_max_time
	
	attr_reader :bug_report_email
	attr_reader :log_viewer_url
	
	attr_reader :guest_buckets;
	
	attr_reader :usersearch_servers;
	
	attr_reader :recurring_payment_user;
	
	# friend_finder
	attr_reader :cloudsponge_key
	attr_reader :cloudsponge_password
